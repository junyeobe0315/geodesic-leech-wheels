...
\url{https://github.com/junyeobe0315/geodesic-leech-wheels}.
...
\end{itemize}
% TODO(author): before submission, mint a Zenodo DOI from a tagged release and
% cite it here alongside the URL, with the version tag named in the text, so
% that referee and reader see the same code. Elsevier and EJC both prefer an
% archival identifier to a mutable repository URL.
